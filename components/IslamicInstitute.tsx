      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {plans.map((plan, index) => (
            <div
              key={index}
              className="border rounded-[28px] p-8 bg-[#FBF7EA] flex flex-col items-center"
            >
              {/* Price Circle */}
              <div className="w-24 h-24 rounded-full bg-yellow-400 flex flex-col items-center justify-center mb-6 border">
              ...
              {/* Students */}
              <div className="bg-yellow-200 text-sm px-4 py-2 rounded-md mb-5">
                {plan.students}
              </div>
              ...
              {/* Button */}
              <button className="mt-auto bg-green-800 text-white px-6 py-2 rounded-md text-sm font-semibold hover:bg-yellow-400 transition">
                Free Trial
              </button>
            </div>
          ))}
